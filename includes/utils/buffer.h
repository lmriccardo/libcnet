...
extern ByteBuffer* ByteBuffer_new_v2(const char *_buffer, const size_t _size) __attribute__((nonnull));
...
extern void ByteBuffer_putBufferFrom(
    ByteBuffer* _self, const char* _src, const int _start, const size_t _size) __attribute__((nonnull));
...
extern void ByteBuffer_getBufferFrom(ByteBuffer* _self, char* _out, const size_t _start, const size_t _size) 
...
extern void checkForOOB(const int _position, const size_t _size, const size_t _max, const char* _func)
    __attribute__((nonnull));
