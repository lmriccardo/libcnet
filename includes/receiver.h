...
extern void  Receiver_start(Receiver* _self, void *(*__process_fn) (char *)) __attribute__((nonnull));
...
extern void* process(char* _buff) __attribute__((nonnull)) __attribute__((deprecated));
